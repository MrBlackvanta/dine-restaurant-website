...
function StoryPanel({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "mt-12 flex v-reveal flex-col items-center text-center sm:mx-auto sm:mt-14 sm:max-w-114.25 wide:mx-0 wide:mt-61.5 wide:w-111.25 wide:max-w-none wide:items-start wide:text-left",
