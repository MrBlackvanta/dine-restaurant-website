...
export default function ReservationHero() {
  return (
    ...
    >
      <div className="absolute inset-x-0 top-0 -z-10 h-150 overflow-clip bg-surface-dark">
        <Picture
          ...
          alt=""
          fetchPriority="high"
          className="size-full v-settle object-cover"
        />
      </div>
      ...
      <div className="v-board mt-11 flex flex-col sm:mt-17.5 wide:mt-38.5 wide:flex-row wide:items-start wide:gap-x-31.25">
        <div className="w-full text-center wide:w-111.25 wide:text-left">
          ...
          >
            <RisingText text="Reservations" />
          </h1>

          <p className="mx-auto mt-3.25 v-enter text-body-sm v-enter-delay-300 sm:mt-3 sm:max-w-143.25 sm:text-body wide:mx-0 wide:mt-4.5 wide:max-w-none">
          ...
          <ButtonLink
            ...
            variant="dark"
            className="mt-4.75 w-61.25 v-enter v-enter-delay-400 sm:hidden"
          >
            Reserve place
          </ButtonLink>
        </div>

        <div className="relative mt-22.75 w-full v-enter v-enter-delay-500 sm:mx-auto sm:mt-9.5 sm:w-135 wide:mx-0 wide:mt-0 wide:shrink-0">
